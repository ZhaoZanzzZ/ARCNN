...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='../ProcessedData_jpeg/train')
    parser.add_argument('--summary_path', type=str, default='../model_jpeg/logs')
    parser.add_argument('--ckpt_path', type=str, default='../model_jpeg/ckpts')
    parser.add_argument('--param_path', type=str, default='../model_jpeg/params')
