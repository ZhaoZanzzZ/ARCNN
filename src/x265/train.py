...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='../ProcessedData_x265/train')
    parser.add_argument('--summary_path', type=str, default='../encoder/model_x265/logs')
    parser.add_argument('--ckpt_path', type=str, default='../encoder/model_x265/ckpts')
    parser.add_argument('--param_path', type=str, default='../encoder/model_x265/params')
